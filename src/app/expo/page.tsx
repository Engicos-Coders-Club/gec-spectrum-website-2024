...
const Expo = () => {
  return (
    <div className="w-screen h-screen mb-40" id="expo">
      ...
      <div className="w-screen p-10 sm:p-10 sm:pr-20 flex justify-between flex-col md:flex-row">
        ...
        <div className="md:w-1/5 p-2 flex flex-col justify-center md:items-end items-center gap-[0.5rem] mt-8 md:mt-0">
          ...
          <h2
            className={`${panchang.className} font-bold md:text-7xl text-5xl text-end`}
          >
            EXPO
          </h2>
          <p
            className={`${space.className} text-[#FFBA25] text-lg md:mt-8 mt-5 py-2 pl-2 text-center sm:text-right`}
          >
