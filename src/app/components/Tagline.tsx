...
const Tagline = () => {
  ...
  return (
    <div className="relative h-[50vh] ">
      ...
      >
        <img
          className="absolute h-[15rem] w-[auto] top-[-10vh] rotate-[25deg] xl:left-[-8vw] lg:left-[-10vw] md:left-[-15vw] sm:left-[-20vw] left-[-30vw]"
      ...
      >
        <img
          className="absolute h-[28rem] sm:h-[35rem] z-[-5] sm:top-[8vh] top-[30vh] rotate-[-26deg] w-[auto] xl:right-[-24vw] lg:right-[-30vw] md:right-[-44vw] sm:right-[-47vw] right-[-50vw]"
