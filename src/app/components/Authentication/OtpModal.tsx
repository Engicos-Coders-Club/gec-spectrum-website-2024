      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className="text-white p-6 rounded-xl shadow-lg w-1/2 bg-[#06050A]">
          <div className="flex justify-between items-center">
            <h2
              className={`mb-4 ${panchang.className} text-2xl text-[#FFBA25] font-semibold`}
            >
              Enter OTP
            </h2>
            <svg
          ...
          <form onSubmit={handleOtpSubmit}>
            ...
            <button
              type="submit"
              className="block w-1/6 mt-10 p-2 mx-auto bg-[#741CFF] text-white rounded-full rounded-tl-none"
            >
              Login
            </button>
          </form>
