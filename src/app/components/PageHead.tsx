...
const PageHead = ({ body, title, faltutext }: PageHeadProps) => {
  return (
    <div
      className={`${panchang.className} w-screen md:h-56  h-40 flex border border-b-[#FFBA25] border-t-white border-x-0 uppercase`}
    >
      ...
      <div className="w-2/6 h-full sm:flex justify-center items-center hidden">
        <p
          className={`${spacemono.className} md:text-[10rem]  text-[#741CFF] text-7xl`}
        >
          {" "}
          {faltutext}
        </p>
