...
const organizers = () => {
  return (
    <div className=" pt-5 md:p-0">
      ...
      <div className="flex justify-around p-20 flex-wrap gap-10 md:gap-5 ">
        {/* Main Council */}
        <div className=" bg-white p-4 rounded-[50%]">
          <Image
        ...
        {/* Computer department */}
        <div className=" bg-white p-[1.2rem] rounded-[50%]">
          <Image
            className="h-32 w-32"
            ...
            width={200}
            alt="COMP Department"
            title="COMP Department"
          ></Image>
        </div>
        {/* ENE department */}
        <div className="bg-black p-4 rounded-[50%]">
          <Image
            className=" h-32 w-32"
