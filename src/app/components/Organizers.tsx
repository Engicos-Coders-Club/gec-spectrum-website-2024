...
const organizers = () => {
  return (
    <div className="my-24 sm:px-10 md:px-20">
      ...
      >
        {/* Main Council */}
        <div className=" bg-white p-4 rounded-[50%] h-28 w-28 md:h-32 md:w-32 object-contain overflow-hidden relative">
          <Image
        ...
        {/* Computer department */}
        <div className=" bg-white p-4 h-28 w-28 md:h-32 md:w-32 rounded-full object-contain overflow-hidden relative">
          <Image
            className="p-5"
        ...
        {/* ENE department */}
        <div className="bg-black p-4 h-28 w-28 md:h-32 md:w-32 rounded-full object-contain overflow-hidden relative">
          <Image
            className=""
