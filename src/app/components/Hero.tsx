  ...
  return (
    <div className='h-fit w-fit flex flex-col items-center justify-center' style={{backgroundImage:'url("/Vector.svg")'}}>
        <div className='md:h-[80vh] h-[60vh] w-screen flex flex-col items-center justify-center text-center'>
            <h1 className={`${myFont.className} md:text-9xl text-4xl font-bold line-clamp-1`}>SPECTRUM</h1>
            <div className='bg-gradient-to-b from-white to-[#111111] text-transparent bg-clip-text'>
                <h2 className={`md:text-4xl font-bold text-xl ${myFont.className}`}>2024</h2>
            </div>
        </div>
        ...
        <div className='md:w-1/3 text-center md:text-2xl font-medium mt-40 tracking-widest'><p className={space.className}>“EMBRACE THE UNKNOWN & GLIDE WITH US THROUGH THE COSMIC SPECTRUM”</p></div>
    </div>
  )
}
