      ...
      <section className="flex gap-4 items-start flex-wrap md:flex-nowrap mx-5 xl:max-w-screen-xl xl:mx-auto my-5">
        ...
        <div className="container mx-auto px-4 text-gray-200 grow">
          ...
          <ul className=" list-none">
            <li>
              <strong className="text-[#FFBA25]">Night Sky observation️:</strong> spotting up and learning
              about different constellation celestial bodies and satellite and
              much more.
            </li>
            <br />
            <li>
              <strong className=" text-[#FFBA25]">Campfire:</strong> Gather around the crackling fire as we
              share stories, laughter, and warmth under the vast expanse of the
              night sky. It's the perfect opportunity to connect with fellow
              enthusiasts and share your passion for astronomy.{" "}
            </li>
            <br />
            <li>
              <strong className="text-[#FFBA25]">Staying in Tents:</strong> Experience the thrill of
              camping out under the stars as you spend the night in cozy tents.
              Feel the magic of the night envelop you as you drift off to sleep
              surrounded by the beauty of nature in tents after an adventurous
              day.
            </li>
            <br />
            ...
            <li>
              {" "}
              <strong className=" text-[#FFBA25]">Space Mythology Stories:</strong> Delve into the rich
              tapestry of space mythology as we explore tales of gods, heroes,
              and celestial phenomena. Discover the fascinating legends behind
              the constellations that adorn the night sky and unlock the
              mysteries of the cosmos.
            </li>
            <br />
            <li>
              {" "}
              <strong className=" text-[#FFBA25]">GEC Campus Trail:</strong> Embark on a guided trail around
              the GEC campus and discover hidden gems and scenic spots under the
              moonlit sky. It's a chance to explore the beauty of our
              surroundings and soak in the serenity of the night.
            </li>
            <br />
            <li>
              {" "}
              <strong className="text-[#FFBA25]"> Astrophotography:</strong> capture up the pictures of
              mesmerizing starry sky with the help of the camera and phone with
              some expert advice.
            </li>
            <br />
