...
const Register = () => {
  return (
    <div className="flex justify-center items-center">
      <div className="h-auto w-[50vw] bg-black my-24 rounded-xl border border-[#3F3F3F] py-8 px-11 flex flex-col sm:gap-4 gap-2">
        <div className="w-full h-16 flex flex-col justify-between">
          ...
          <div className="h-5 w-full flex justify-center items-center"><p className={`${space.className} font-medium text-xs leading-5 text-center`}>Already registered? Login <Link href='/' className={`${merri.className} hover:underline font-normal`}>here</Link></p></div>
        </div>
        ...
        <div className="w-full h-16 flex flex-col gap-1">
            <h2 className="text-white font-medium leading-5 text-sm">Confirm Password</h2>
            <div className="w-full h-9 rounded-lg border-none">
            <input type="text" placeholder="Text Here" className="bg-[#323232] size-full rounded-lg py-2 px-4 inset-0 placeholder:text-white placeholder:text-sm placeholder:font-medium placeholder:leading-5"/>
            </div>
        </div>
        <div className="w-full h-9 flex justify-center items-center">
            <div className="h-full w-24 bg-[#741CFF] rounded-r-2xl rounded-b-2xl">
                <button className="size-full py-2 px-4 font-bold text-sm" onClick={handleSubmit}>SIGNUP</button>
            </div>
        </div>
      </div>
    </div>
